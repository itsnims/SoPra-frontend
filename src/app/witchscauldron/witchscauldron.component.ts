...
@Component({
  selector: 'app-witchscauldron',
  templateUrl: './witchscauldron.component.html',
  styleUrls: ['./witchscauldron.component.css']
})
export class WitchscauldronComponent implements OnInit, AfterViewInit {
